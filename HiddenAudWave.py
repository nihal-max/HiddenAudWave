...
# Coded By "Nihal Tiwari" (BinaryBite Security)
# Hide your secret text in wave audio file.
import os
import wave
import argparse
parser = argparse.ArgumentParser()
parser.add_argument('-f', help='This Option Is To Select Audio File', dest='audiofile')
parser.add_argument('-m', help='Enter your Secret Message Here In Comma', dest='secretmsg')
parser.add_argument('-o', help='Your Output File Name And If Want To Save In Other Location The Path Like (home/Downloads/BinaryBite.wav)', dest='outputfile')
